function [ channelPairs, x, channels ] = allChannelCoherence( EEG )
...
while(fftEndIndex < size(EEG.data,2))
    ...
    for chanCounter = 1:EEG.nbchan
        ...
        for i = iRange
            ...
            powerSum(i, chanCounter) = powerSum(i, chanCounter) + powerArray(coherenceIndex, i, chanCounter);
            avgPow(i,chanCounter) = powerSum(i, chanCounter) / queueLength;
        end
    end
                ...
                for i = iRange
                    ...
                    if(coherenceFull)
                        ...
                        channelPairs(channelPairIndex).coherence(coherenceCount, i) = ...
                            ...
                            / (avgPow1*avgPow2);
                        channels(chan1).absolutePower(coherenceCount, i) = avgPow1;
                    end
                end
