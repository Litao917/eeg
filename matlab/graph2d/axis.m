...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function LocSetManual(ax)
if ~graphicsversion(ax,'handlegraphics')
    get(ax,{'XLim','YLim','ZLim'});
end
set(ax,...
    'XLimMode','manual',...
    'YLimMode','manual',...
...
function LocSetTight(ax)
    if graphicsversion(ax,'handlegraphics')
        ...
        set(ax,'XLimSpec','tight','YLimSpec','tight','ZLimSpec','tight');
        set(ax,'XLimMode','auto','YLimMode','auto','ZLimMode','auto')
    end

function LocSetTight1(ax)
