...
%--------------------------------------------------------------------------
    ...
    function plotRects
        ...
        Y = [bottom(1:end-1,:) + bsxfun(@times,phi(1,:),dydt(1:end-1,:)); ...
            bsxfun(@plus,bottom(end,:),bsxfun(@times,phi(1:end,:),dydt(end,:))); ...
            flipud(bottom(1:end-1,:) + bsxfun(@times,phi(end,:),dydt(1:end-1,:))); ...
            flipud(bsxfun(@plus,bottom(1,:),bsxfun(@times,phi(1:end-1,:),dydt(1,:))))];
        figure;
