...
if nargin < 3 || isempty(flag) % odephas3(t,y) [v5 syntax] or odephas3(t,y,'')
    ...
    if (isempty(TARGET_FIGURE) || isempty(TARGET_AXIS))
        ...
        error(message('MATLAB:odephas3:NotCalledWithInit'));
    ...
    elseif (ishghandle(TARGET_FIGURE) && ishghandle(TARGET_AXIS))  % figure still open   
        ...
        try
            ...
            error(message('MATLAB:odephas3:ErrorUpdatingWindow', ME.message));
        end                             
    end
    ...
    switch(flag)
      case 'init'                           % odephas3(tspan,y0,'init')
        ...
        if isempty(h)
            ...
            uicontrol( ...
                'Style','push', ...
                'String',getString(message('MATLAB:odephas3:ButtonStop')), ...
                'Position',pos, ...
