...
for k=1:length(allc)
  ...
  % Correct for improper case for isprop
  if strcmpi(posProp,'outerposition')
      posProp = 'OuterPosition';
  elseif strcmpi(posProp,'position')
    posProp = 'Position';
  end
...
% LocalWords:  xtick ytick horizontalalignment verticalalignment fontname
% LocalWords:  fontweight fontsize fontangle paperfigtstring paperfigtdate
