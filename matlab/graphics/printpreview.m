...
figPreview = graphics.internal.createPrintPreviewFigure();
...
p = javaObjectEDT('com.mathworks.page.export.PreviewTabMisc', model, true);
...
haderror = false;
try
    graphics.internal.createPrintPreviewCData(axPreview, fig);
catch ex
