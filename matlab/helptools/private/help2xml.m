...
[isOperator, topic] = helpUtils.isOperator(topic, true);
...
[localTopic, hasLocalFunction] = helpUtils.fixLocalFunctionCase(topic);

if hasLocalFunction
    fcnName =  helpUtils.extractCaseCorrectedName(localTopic, topic);
...
otherwise
    ...
    newFcnName = helpUtils.extractCaseCorrectedName(which(fcnName), fcnName);
...
if ~isempty(metacls)
    ...
    elseif classInfo.isSimpleElement
        ...
        [classElement, elementKeyword] = helpUtils.getSimpleElement(metacls, elementName);
