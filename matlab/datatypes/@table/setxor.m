...
%
%   See also TABLE/UNION, TABLE/INTERSECT, TABLE/SETDIFF, TABLE/ISMEMBER,
%            TABLE/UNIQUE, TABLE/SORTROWS.
...
n = size(uA,1);
d = indSortuAuB > n;           
ia = ia(indSortuAuB(~d,1));        % Find indices in indSortuAuB that belong to A 
ib = ib(indSortuAuB(d,1)-n);     % Find indices in indSortuAuB that belong to B
