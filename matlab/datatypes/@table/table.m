classdef (Sealed, SupportExtensionMethods = true) table %#ok<ATUNK>
%TABLE Table.
...
%   Copyright 2012-2013 The MathWorks, Inc.
    ...
    properties(Constant, GetAccess='private')
        version = 1.0;
        propsFieldNames = ...
            {'Description'; 'VariableDescriptions'; 'VariableUnits';                   'DimensionNames'; 'UserData'};
        propsFieldDflts = ...
            {           '';                     {};              {}; matlab.internal.table.dfltDimNames;        [] };
        propertyNames = [ table.propsFieldNames; {'RowNames'; 'VariableNames'} ];
    end
    properties(GetAccess='private', SetAccess='private')
        ...
        props = cell2struct(table.propsFieldDflts, table.propsFieldNames, 1);
    end
...
%   See also READTABLE, CELL2TABLE, ARRAY2TABLE, STRUCT2TABLE. 
    ...
    methods(Hidden = true, Static = true)
        ...
        function t = loadobj(t)
            ...
            toRemove = setdiff(fieldnames(t.props),table.propsFieldNames);
            if ~isempty(toRemove)
    ...
    methods(Access = 'protected')
        ...
        function b = cloneAsEmpty(a)
            ...
            b.data = cell(1,0);
            b.props = cell2struct(table.propsFieldDflts, table.propsFieldNames, 1);
        end
