...
%   Description and UserData properties in T using the the first non-empty
%   value for the corresponding property in the arrays T1, T2, ... .
%
%   See also TABLE/CAT, TABLE/VERTCAT, TABLE/JOIN.
