...
%                         only A's copy.  'KeepOneCopy' is a a variable name or a
...
%     c = join(a,b)
%
%   See also TABLE/INNERJOIN, TABLE/OUTERJOIN, TABLE/HORZCAT, TABLE/SORTROWS,
%            TABLE/UNION, TABLE/INTERSECT, TABLE/ISMEMBER, TABLE/UNIQUE.
