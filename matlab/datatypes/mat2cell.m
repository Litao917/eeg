...
if nargin==0
    error(message('MATLAB:mat2cell:NoInputs'));
end

switch nargin
    
case 1
    warning(message('MATLAB:mat2cell:ObsoleteSingleInput'));
    c={x};
...
otherwise
    ...
    if length(varargin) ~= ndims(x)
        ...
        if singleFlag
            warning(message('MATLAB:mat2cell:TrailingUnityVectorArgRemoved', ...
