classdef (Abstract) ActionBehavior_IsInQuickAccess < handle
    ...
    methods
        ...
        function addToQuickAccess(this, varargin)
            ...
            %   access bar. 
            %   Example:
            %       btn = matlab.ui.internal.toolstrip.PushButton('New',Icon.NEW_16)
            %       btn.addToQuickAccess()
        ...
        function removeFromQuickAccess(this)
            ...
            %
            %   "removeFromQuickAccess(item)": remove this control from
    ...
    methods (Hidden)
        ...
        function properties = getDefaultIsInQuickAccessProperties(this, properties) %#ok<*INUSL>
            properties.isInQAB = false;
        end
