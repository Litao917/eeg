...
%
%   L = IMPORT(...) returns as a cell array of strings the contents of the
%   current import list as it exists when IMPORT completes.
...
%
%   IMPORT affects only the import list of the function within which it is
%   used.  There is also a base import list that is used at the command
%   prompt.  If IMPORT is used in a script, it will affect the import list
%   of the function which invoked the script, or the base import list if
%   the script is invoked from the command prompt.
%
