...
%  VALUE are both strings. If NAME already exists as an environment
%  variable, then SETENV replaces its current value with the string
%  given in VALUE. If NAME does not exist, SETENV creates a new
%  environment variable called NAME and assigns VALUE to it.
%
...
%  not well-defined.
%
%  On all platforms, SETENV passes the NAME and VALUE strings to the
%  operating system unchanged. Special characters such as ';', '/', 
