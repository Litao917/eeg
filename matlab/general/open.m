...
%   .p    file    if NAME resolves to a P-file and NAME did not end with
%                 .p extension, attempts to open matching file with .m
%                 extension. If NAME did end with a .p extension, displays
%                 an error.
%   .mat  file    open MAT file; store variables in a structure
%   .mdl  file    open model in SIMULINK
%   .slx  file    open model in SIMULINK
...
%                               f2.mdl or f2.m.  Error if can't find any
%                               of these.
%
...
%
%   See also SAVEAS, WHICH, LOAD, UIOPEN, PATH.
%
