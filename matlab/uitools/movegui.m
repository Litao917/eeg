...
setActivePositionProperty(fig, oldposmode);
...
%----------------------------------------------------
function actPosProp = getActivePositionProperty(fig)
actPosProp = '';
if (graphicsversion(fig,'handlegraphics') == 1)
    actPosProp = get(fig,'ActivePositionProperty');
end

%----------------------------------------------------
function setActivePositionProperty(fig, actPosProperty)
if (graphicsversion(fig,'handlegraphics') == 1)
    set(fig,'ActivePositionProperty', actPosProperty);
end
