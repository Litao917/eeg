classdef (CaseInsensitiveProperties = true) uimode < hgsetget 
...
%       startModeHGUsingMATLABClasses -  Use the Scene Viewer events to delegate to the mode callback functions.
...
methods  %% public methods
    ...
    startModeHGUsingMATLABClasses(hThis)
