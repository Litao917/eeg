...
if ~strcmp(this.dirty,'clean')
  ...
  if ~any(size(c,2) == [1 3])
    msg = getString(message('MATLAB:scatter:CDataMustBeColorSpec'));
  end
  ...
  if (length(x) ~= length(y)) || ...
    ...
    msg = getString(message('MATLAB:scatter:DataLengthMustMatch'));
  end
    ...
    if length(x) > 100 && (constantcolor || size(c,2) == 1)
      ...
      for k = 1:length(xi)
        ...
        p = patch('Parent',double(this),...
                  ...
                  'FaceColor','none',...
                  'EdgeColor','none',...
                  'LineWidth',get(this,'LineWidth'),...
                  'MarkerFaceColor',mfc,...
                  'MarkerEdgeColor',mec,...
                  'Marker',get(this,'Marker'),...
                  'MarkerSize',sqrt(uniquesizes(k)));
