...
if numel(limits)~=6 
  error(message('MATLAB:subvolume:InvalidReductionSize'));
end
...
if limits(5) > limits(6)
  error(message('MATLAB:subvolume:InvalidRedutionZRange'));
end
...
elseif nin==7       % subvolume(x,y,z,u,v,w,lims)
  ...
  error(message('MATLAB:subvolume:WrongNumberOfInputs')); 
end
