classdef CombinableConstraint < matlab.unittest.constraints.Constraint
    ...
    properties (Hidden, SetAccess = immutable, GetAccess = protected)
        FirstConditionHeader = getString(message('MATLAB:unittest:Constraint:FirstConditionHeader'));
        SecondConditionHeader = getString(message('MATLAB:unittest:Constraint:SecondConditionHeader'));
