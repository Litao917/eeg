classdef Assumable < matlab.mixin.Copyable
    ...
    methods(Sealed)
        ...
        function assumeFail(assumable, varargin)
            ...
            %               testCase.assumeFail('This listener callback should not have executed');
            %           end
            %       end
            %
            %   See also
            ...
            qualifyFail(assumable.AssumptionDelegate, ...
                @assumable.notifyAssumptionPassed, ...
                @assumable.notifyAssumptionFailed, ...
                varargin{:});
        end
        ...
        function assumeTrue(assumable, actual, varargin)
            ...
            %       testCase.assumeTrue(~isempty(strfind('string', 'ring')), ...
        ...
        function assumeError(assumable, actual, errorClassOrID, varargin)
            % assumeError - Assume a function throws a specific exception
            %
            ...
            %       matlab.unittest.diagnostics.Diagnostic
            % 
            qualifyError(assumable.AssumptionDelegate, ...
                @assumable.notifyAssumptionPassed, ...
                @assumable.notifyAssumptionFailed, ...
    ...
    methods (Access = private)
        function notifyAssumptionPassed(assumable, qualificationEventData)
            assumable.notify('AssumptionPassed', qualificationEventData);
        end
 
        function notifyAssumptionFailed(assumable, qualificationEventData)   
            assumable.notify('AssumptionFailed', qualificationEventData);
        end
    end
    ...
    methods
        function set.AssumptionDelegate(assumable, delegate)
            validateattributes(delegate, ...
                {'matlab.unittest.internal.qualifications.AssumptionDelegate'},...
                {'scalar'},'','delegate');
            assumable.AssumptionDelegate = delegate;
        end
    end
