classdef FatalAssertable < matlab.mixin.Copyable
    ...
    methods(Sealed)
        ...
        function fatalAssertFail(fatalAssertable, varargin)
            ...
            qualifyFail(fatalAssertable.FatalAssertionDelegate, ...
                @fatalAssertable.notifyFatalAssertionPassed, ...
                @fatalAssertable.notifyFatalAssertionFailed, ...
                varargin{:});
        end
        ...
        function fatalAssertTrue(fatalAssertable, actual, varargin)
            ...
            %       testCase.fatalAssertTrue(~isempty(strfind('string', 'ring')), ...
        ...
        function fatalAssertError(fatalAssertable, actual, errorClassOrID, varargin)
            % fatalAssertError - Fatally assert a function throws a specific exception
            %
            ...
            %       matlab.unittest.diagnostics.Diagnostic
            % 
            qualifyError(fatalAssertable.FatalAssertionDelegate, ...
                @fatalAssertable.notifyFatalAssertionPassed, ...
                @fatalAssertable.notifyFatalAssertionFailed, ...
    ...
    methods (Access = private)
        function notifyFatalAssertionPassed(fatalAssertable, qualificationEventData)
            fatalAssertable.notify('FatalAssertionPassed', qualificationEventData);
        end
 
        function notifyFatalAssertionFailed(fatalAssertable, qualificationEventData)   
            fatalAssertable.notify('FatalAssertionFailed', qualificationEventData);
        end
    end
    ...
    methods
        function set.FatalAssertionDelegate(fatalAssertable, delegate)
            validateattributes(delegate, ...
                {'matlab.unittest.internal.qualifications.FatalAssertionDelegate'},...
                {'scalar'},'','delegate');
            fatalAssertable.FatalAssertionDelegate = delegate;
        end
    end
