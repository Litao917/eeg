classdef Assertable < matlab.mixin.Copyable
    ...
    methods(Sealed)
        ...
        function assertFail(assertable, varargin)
            ...
            qualifyFail(assertable.AssertionDelegate, ...
                @assertable.notifyAssertionPassed, ...
                @assertable.notifyAssertionFailed, ...
                varargin{:});
        end
        ...
        function assertTrue(assertable, actual, varargin)
            ...
            %       testCase.assertTrue(~isempty(strfind('string', 'ring')), ...
        ...
        function assertError(assertable, actual, errorClassOrID, varargin)
            % assertError - Assert a function throws a specific exception
            %
            ...
            %       matlab.unittest.diagnostics.Diagnostic
            % 
            qualifyError(assertable.AssertionDelegate, ...
                @assertable.notifyAssertionPassed, ...
                @assertable.notifyAssertionFailed, ...
    ...
    methods (Access = private)
        function notifyAssertionPassed(assertable, qualificationEventData)
            assertable.notify('AssertionPassed', qualificationEventData);
        end
 
        function notifyAssertionFailed(assertable, qualificationEventData)   
            assertable.notify('AssertionFailed', qualificationEventData);
        end
    end
    ...
    methods
        function set.AssertionDelegate(assertable, delegate)
            validateattributes(delegate, ...
                {'matlab.unittest.internal.qualifications.AssertionDelegate'},...
                {'scalar'},'','delegate');
            assertable.AssertionDelegate = delegate;
        end
    end
