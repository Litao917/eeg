classdef Verifiable < matlab.mixin.Copyable
    ...
    methods(Sealed)
        ...
        function verifyFail(verifiable, varargin)
            ...
            qualifyFail(verifiable.VerificationDelegate, ...
                @verifiable.notifyVerificationPassed, ...
                @verifiable.notifyVerificationFailed, ...
                varargin{:});
        end
        ...
        function verifyError(verifiable, actual, errorClassOrID, varargin)
            % verifyError - Verify a function throws a specific exception
            %
    ...
    methods (Access = private)
        function notifyVerificationPassed(verifiable, qualificationEventData)
            verifiable.notify('VerificationPassed', qualificationEventData);
        end
 
        function notifyVerificationFailed(verifiable, qualificationEventData)   
            verifiable.notify('VerificationFailed', qualificationEventData);
        end
    end
    ...
    methods
        function set.VerificationDelegate(verifiable, delegate)
            validateattributes(delegate, ...
                {'matlab.unittest.internal.qualifications.VerificationDelegate'},...
                {'scalar'},'','delegate');
            verifiable.VerificationDelegate = delegate;
        end
    end
