...
hmenu.Timeseries = hplot.addMenu('waves','Label', ...
    getString(message('MATLAB:timeseries:TimeSeries')), ...
    'Tag', 'Time series'); 

% Create a Characteristics menu 
if ~strcmp(plotType,'CorrPlot')
    hmenu.Characteristics = hplot.addMenu('characteristics');
    set(hmenu.Characteristics,'Label', ...
        getString(message('MATLAB:timeseries:Annotations')), ...
        'Tag', 'Annotations');
end
...
undoMenu = uimenu('Parent',AxGrid.UIcontextMenu,...
    'Label', getString(message('MATLAB:timeseries:Undo')), ...
    'Tag','undo','Separator','on',...
    'Callback',{@localUndo hplot});
redoMenu = uimenu('Parent',AxGrid.UIcontextMenu,...
    'Label',getString(message('MATLAB:timeseries:Redo')), ...
    'Tag','redo',...
...
editMenu = uimenu('Parent',AxGrid.UIcontextMenu,...
    'Label',getString(message('MATLAB:timeseries:EditPlot')), ...
    'Tag','edit','Separator','on',...
