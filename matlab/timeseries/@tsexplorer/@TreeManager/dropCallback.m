...
abortFlag = false;
if length(tsList)>10
    ButtonName = questdlg(sprintf(getString(message('MATLAB:tsexplorer:TreeManager:dropCallback:AttemptingToPlotMoreThanTSRange',length(tsList)))), ...
                       getString(message('MATLAB:tsexplorer:TreeManager:dropCallback:TimeSeriesTools')), ...
                       getString(message('MATLAB:tsexplorer:TreeManager:dropCallback:Continue')), ...
                       getString(message('MATLAB:tsexplorer:TreeManager:dropCallback:Abort')), ...
                       getString(message('MATLAB:tsexplorer:TreeManager:dropCallback:Abort')));
    if strcmp(ButtonName,getString(message('MATLAB:tsexplorer:TreeManager:dropCallback:Abort')));
        abortFlag = true;
    end
end
