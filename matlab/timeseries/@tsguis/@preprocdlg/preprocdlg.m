...
if isempty(dlg) || ~ishandle(dlg)
    ...
    dlg.Figure = figure('Units','Characters','Position',[50 19 90 37],'Toolbar',...
       'None','Numbertitle','off','Menubar','None','Name',getString(message('MATLAB:timeseries:tsguis:preprocdlg:ProcessData')),...
    ...
    dlg.Handles.LBLselts = uicontrol('Style','Text','Parent',dlg.Figure,'Units','Characters','Position',...
       [3 34 16 1.154],'String',getString(message('MATLAB:timeseries:tsguis:preprocdlg:SelectView')),'HorizontalAlignment',...
       'Left');
