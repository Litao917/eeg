...
h.Handles.LBLtsxlabel = uicontrol('Style','text', ...
    'String',getString(message('MATLAB:timeseries:tsguis:tsxynode:TimeSeriesAlignedWithXAxis')),...
    'HorizontalAlignment','left','Parent',h.Handles.PNLXts,'Units','characters');
h.Handles.BTNtsx= uicontrol('Style','pushbutton', ...
    'String',getString(message('MATLAB:timeseries:tsguis:tsxynode:Select')),...
...
h.Handles.tableModelX = tsMatlabCallbackTableModel(cell(0,2),...
    {getString(message('MATLAB:timeseries:tsguis:tsxynode:Name')), ...
    getString(message('MATLAB:timeseries:tsguis:tsxynode:NumberOfColumns'))},[],[]);
...
h.Handles.LBLtsylabel = uicontrol('Style','text', ...
    'String',getString(message('MATLAB:timeseries:tsguis:tsxynode:TimeSeriesAlignedWithYAxis')),...
    'HorizontalAlignment','left','Parent',h.Handles.PNLYts,'Units','characters');
h.Handles.BTNtsy = uicontrol('Style','pushbutton', ...
    'String',getString(message('MATLAB:timeseries:tsguis:tsxynode:Select')),...
