...
switch menuType
    case 'selectrule'
        ...
        mRoot = uimenu('Parent',AxGrid.UIcontextMenu,...
            'Label',getString(message('MATLAB:timeseries:tsguis:tsplot:SelectData')),'Tag','selectrule',...
            'Callback',@(es,ed) openselectdlg(this),varargin{:});
    case 'merge'
        % Show input signal
        mRoot = uimenu('Parent',AxGrid.UIcontextMenu,...
            'Label',getString(message('MATLAB:timeseries:tsguis:tsplot:ResampleData')),'Tag','merge',...
            'Callback',@(es,ed) tsguis.mergedlg(this),varargin{:});
    case 'removemissingdata'
        mRoot = uimenu('Parent',AxGrid.UIcontextMenu,...
            'Label',getString(message('MATLAB:timeseries:tsguis:tsplot:RemoveMissingData')),'Tag','removemissingdata',...
            'Callback',{@localPreproc this 4});
    case 'detrend'
        mRoot = uimenu('Parent',AxGrid.UIcontextMenu,...
            'Label',getString(message('MATLAB:timeseries:tsguis:tsplot:Detrend')),'Tag','detrend',...
            'Callback',{@localPreproc this 1});
    case 'filter'
        mRoot = uimenu('Parent',AxGrid.UIcontextMenu,...
            'Label',getString(message('MATLAB:timeseries:tsguis:tsplot:Filter')),'Tag','filter',...
            'Callback',{@localPreproc this 2});
    case 'interpolate'
        mRoot = uimenu('Parent',AxGrid.UIcontextMenu,...
            'Label',getString(message('MATLAB:timeseries:tsguis:tsplot:Interpolate')),'Tag','interpolate',...
