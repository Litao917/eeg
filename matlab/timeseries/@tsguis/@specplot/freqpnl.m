...
h.Handles.TabPane.add(getString(message('MATLAB:timeseries:tsguis:specplot:DefineFrequencyVector')),outerFreqPanel);     
...
LBLstart = MJLabel(getString(message('MATLAB:timeseries:tsguis:specplot:StartFrequency')));
...
set(handle(h.Handles.FreqPnl_EDITstart,'callbackproperties'),'FocusLostCallback',...
   {@localFreqUpdate h view});
LBLend = MJLabel(getString(message('MATLAB:timeseries:tsguis:specplot:EndFrequency')));
...
set(handle(h.Handles.FreqPnl_EDITend,'callbackproperties'),'FocusLostCallback',...
   {@localFreqUpdate h view});
LBLunits = MJLabel(getString(message('MATLAB:timeseries:tsguis:specplot:Units')));
...
%% Create Help button
h.Handles.HelpButton = MJButton(getString(message('MATLAB:timeseries:tsguis:specplot:Help')));
...
PanningPnl.add(MJLabel(getString(message('MATLAB:timeseries:tsguis:specplot:PanFrequencyAxis'))),BorderLayout.WEST);
h.Handles.FreqPanScroll = tsMatlabCallbackScrollBar;
h.Handle.ResetFreqBtn = MJButton(getString(message('MATLAB:timeseries:tsguis:specplot:Reset')));
