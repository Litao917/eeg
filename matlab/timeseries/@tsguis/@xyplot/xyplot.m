...
'Title',    getString(message('MATLAB:timeseries:tsguis:xyplot:XYPlotPlain')), ...
'XLabel',   '',...
'YLabel',  '',...
'XUnit',  '');
init_graphics(h)
...
%% Add char menus
regchar = h.addCharMenu(menus.Characteristics, ...
    getString(message('MATLAB:timeseries:tsguis:xyplot:BestFitLine')),...
