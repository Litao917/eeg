...
if ~isempty(h.Handles.tsTable)
    ...
    try
        ...
        errordlg(getString(message('MATLAB:tsguis:excelImportdlg:getTimeColumn:InvalidTimesSelectedReselectTimeVector')),...
            getString(message('MATLAB:tsguis:excelImportdlg:getTimeColumn:TimeSeriesTools')),'modal');
        time=[];
        timeFormat=[];
        return
    end
