...
if ~isempty(h.Handles.tsTable)
    ...
    try
        ...
        errordlg(getString(message('MATLAB:tsguis:excelImportdlg:getTimeRow:InvalidTimesSelectedReselectTimeVector')),...
            getString(message('MATLAB:tsguis:excelImportdlg:getTimeRow:TimeSeriesTools')),'modal');
        time=[];
        timeFormat=[];
        return
    end
