...
h.Handles.PNLDomain = uipanel('Parent',f,'Units','Pixels','Title', ...
    getString(message('MATLAB:timeseries:tsguis:tsspecnode:DefineDomainRange')));

%% Build freq panel components
LBLStart = uicontrol('Style','Text', ...
    'String',getString(message('MATLAB:timeseries:tsguis:tsspecnode:StartFreq')), ...
    'HorizontalAlignment',...
...
LBLEnd = uicontrol('Style','Text',...
    'String',getString(message('MATLAB:timeseries:tsguis:tsspecnode:EndFreq')), ...
    'HorizontalAlignment',...
...
h.Handles.TXTEndFreq = uicontrol('Style','Edit','Parent',h.Handles.PNLDomain,'Units','Pixels', ...
    ...
    {@localFreqUpdate h},'HorizontalAlignment','Left','BackgroundColor',[1 1 1]);
LBLUnits = uicontrol('Style','Text', ...
    'String',getString(message('MATLAB:timeseries:tsguis:tsspecnode:Units')), ...
    'HorizontalAlignment',...
...
h.Handles.TXTFreqUnits = uicontrol('Style','Popupmenu','Parent',h.Handles.PNLDomain,'Units','Pixels', ...
    'Position',[286+33+10 45 63+30 21], ...
    'String',{getString(message('MATLAB:timeseries:tsguis:tsspecnode:Cycsecond'))}, ...
...
h.Handles.CHKcummulative = uicontrol('Style','Checkbox','Parent',h.Handles.PNLDomain, ...
    'Units','Pixels','Position',[13 45-30 173 21], ...
    'String', getString(message('MATLAB:timeseries:tsguis:tsspecnode:ShowCumulativePeriodogram')), ...
