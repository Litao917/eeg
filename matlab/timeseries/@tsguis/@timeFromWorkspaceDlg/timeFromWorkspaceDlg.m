...
h.Handles.BTNselect = uicontrol('Parent', h.Figure, 'Position',[ScreenSize(3)*widthratio-3*widthbtn-3*separation, separation, widthbtn, heightbtn],...
    ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:Select')), ...
    'Tag', 'BTNselect');
h.Handles.BTNcancel = uicontrol('Parent',h.Figure,'Position',[ScreenSize(3)*widthratio-2*widthbtn-2*separation, separation, widthbtn, heightbtn],...
    ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:Cancel')), ...
    'Tag', 'BTNcancel');
h.Handles.BTNhelp = uicontrol('Parent',h.Figure,'Position',[ScreenSize(3)*widthratio-widthbtn-separation, separation, widthbtn, heightbtn],...
    'Style', 'pushbutton','Callback', {@localHELP h}, 'String', ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:Help')));
% workspace browser
...
if ~isempty(filename)
    ...
    set(h.Figure, 'Name', ...
        getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:SelectTimeVectorFrom',filename)));
else
    set(h.Figure, 'Name', ...
        getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:SelectTimeVectorFromMATLABWorkspaceVariable')));
end
...
h.Handles.TXTrowcolumn = uicontrol('Parent',h.Figure,...
    ...
    'string', ...
    [getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:TimeIsArrangedBy')) ' '], ...
...
uimenu(huicTXTrowcolumn,'Label', ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:WhatsThis')), ...
    'Callback','tsDispatchHelp(''select_time_arranged'',''modal'')')

h.Handles.COMBrowcolumn = uicontrol('Parent',h.Figure,...
    'style','popupmenu',...
    'Units', 'Pixels',...
    'String',[{...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:Column'))}, ...
    {getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:Row'))}],...
    'TooltipString', ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:SelectAColumnIf')),...
...
h.Handles.TXTindex = uicontrol('Parent',h.Figure,...
    ...
    'HorizontalAlignment','Right', ...
    'string', ...
    [getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:ColumnIndices')) ' '], ...
...
uimenu(huicTXTindex,'Label', ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:WhatsThis')), ...
    'Callback','tsDispatchHelp(''select_time_column'',''modal'')')
...
h.Handles.COMBindex = uicontrol('Parent',h.Figure,...
    ...
    'String',' ',...
    'TooltipString', ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:SelectTheColumnrowIndex')),...
...
h.Handles.TXTindices = uicontrol('Parent',h.Figure,...
    ...
    'HorizontalAlignment','Right', ...
    'string', ...
    [getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:RowIndices')) ' '], ...
...
uimenu(huicTXTindices,'Label', ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:WhatsThis')), ...
    'Callback','tsDispatchHelp(''select_time_rows'',''modal'')')
...
if ~isempty(info)
    if get(h.Handles.COMBrowcolumn,'Value')==1
        ...
        uimenu(huicTXTindex,'Label', ...
            getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:WhatsThis')),...
            'Callback','tsDispatchHelp(''select_time_column'',''modal'')')
        set(h.Handles.TXTindex,'String', ...
            [getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:ColumnIndex')) ' '], ...
            'UIContextMenu',huicTXTindex);
        huicTXTindices = uicontextmenu('Parent',h.Figure);
        uimenu(huicTXTindices,'Label', ...
            getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:WhatsThis')), ...
            'Callback','tsDispatchHelp(''select_time_rows'',''modal'')')
        set(h.Handles.TXTindices,'String', ...
            [getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:RowIndices')) ' '], ...
            'UIContextMenu',huicTXTindices);
        ...
        uimenu(huicTXTindex,'Label', ...
            getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:WhatsThis')), ...
            'Callback','tsDispatchHelp(''select_time_row'',''modal'')')
        set(h.Handles.TXTindex,'String', ...
            [getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:RowIndex')) ' '], ...
            'UIContextMenu',huicTXTindex);
        huicTXTindices = uicontextmenu('Parent',h.Figure);
        uimenu(huicTXTindices,'Label', ...
            getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:WhatsThis')), ...
            'Callback','tsDispatchHelp(''select_time_columns'',''modal'')')
        set(h.Handles.TXTindices,'String', ...
            [getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:ColumnIndices')) ' '], ...
            'UIContextMenu',huicTXTindices);
        set(h.Handles.COMBindex,'String',mat2cell((1:length)',ones(length,1),1),'Value',1); %#ok<MMTC>
...
if ~isempty(info)
    if get(h.Handles.COMBrowcolumn,'Value')==1
        try
            ...
            errordlg(getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:InvalidTimeVectorSelected')), ...
                getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:TimeSeriesTools')));
            return;
        end
        if isnumeric(h.OutputValue)
            h.OutputString=sprintf('\n  %s', ...
                getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:VariableInformation', ...
                info.varname, num2str(length(range)), num2str(h.OutputValue(1)), num2str(h.OutputValue(end)))));
        elseif ischar(h.OutputValue)
             h.OutputString=sprintf('\n  %s', ...
                getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:VariableInformation', ...
                info.varname, num2str(length(range)), h.OutputValue(1,:), h.OutputValue(end,:))));
        elseif iscell(h.OutputValue)
            ...
            try
                ...
                if all(cellfun('isclass',h.OutputValue,'char'))
                    h.OutputString=sprintf('\n  %s', ...
                        getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:VariableInformation', ...
                        info.varname, num2str(length(range)), h.OutputValue{1,:}, h.OutputValue{1,:}))); 
                end
            end
            if isnumeric(tmpValue) && ~isempty(tmpValue)
                h.OutputString=sprintf('\n  %s', ...
                    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:VariableInformation', ...
                    info.varname, num2str(length(range)), num2str(tmpValue(1)), num2str(tmpValue(end)))));
             elseif ischar(tmpValue) && ~isempty(tmpValue)
                h.OutputString=sprintf('\n  %s', ...
                    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:VariableInformation', ...
                    info.varname, num2str(length(range)), tmpValue(1,:), tmpValue(end,:))));
             end
        end
    else
        try
...
helpdlg(sprintf('%s\n\n%s\n\n%s\n\n%s\n\n%s',...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:DefineTimeVectorFromAWorkspaceVariable')),...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:Step1HighlightTheVariable')), ...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:Step2ClickTheSelectButton'))),...
    getString(message('MATLAB:timeseries:tsguis:timeFromWorkspaceDlg:Help')));
