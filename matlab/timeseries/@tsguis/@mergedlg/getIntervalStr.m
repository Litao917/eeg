...
%% NO-op
if isempty(tsList)
   maxStart = getString(message('MATLAB:timeseries:tsguis:mergedlg:EmptyTimeVector'));
   minEnd = getString(message('MATLAB:timeseries:tsguis:mergedlg:EmptyTimeVector'));
   return
end
...
% Invalidate absTimeFlag if one or more selected time series are relative
...
if strcmp(method,'union')
        ...
        if maxStart>minEnd
            startStr = getString(message('MATLAB:timeseries:tsguis:mergedlg:EmptyTimeVector'));
            endStr = getString(message('MATLAB:timeseries:tsguis:mergedlg:EmptyTimeVector'));
        else
