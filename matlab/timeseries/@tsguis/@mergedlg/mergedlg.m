...
if isempty(dlg) || ~ishandle(dlg)
    ...
    dlg.Figure = figure('Units','Characters','Position',[104 21.7627 85.4 39.7573],'Toolbar','None',...
        ...
        getString(message('MATLAB:timeseries:tsguis:mergedlg:ResampleData')),...
        'Visible','off','closeRequestFcn',@(es,ed) set(dlg,'Visible','off'),'HandleVisibility',...
        'callback','IntegerHandle','off','Resize','off','Tag','ResampleDataDlg');
    ...
    TXTselectView = uicontrol('style','text','String', ...
        getString(message('MATLAB:timeseries:tsguis:mergedlg:SelectThePlot')), ...
        'Units',...
