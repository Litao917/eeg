...
%% Update title
if length(h.Waves)==1
    h.axesgrid.Title = getString(message('MATLAB:tsguis:histplot:addTs:HistogramOfTSName',ts.Name));
else
    h.axesgrid.Title = getString(message('MATLAB:tsguis:histplot:addTs:HistogramOfMultipleTimeSeries'));
end
