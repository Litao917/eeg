...
'Title',    getString(message('MATLAB:tsguis:histplot:histplot:Histogram')), ...
'XLabel',   '',...
'YLabel',  '',...
'XUnit',  '');
init_graphics(h)
...
mean_menu = h.addCharMenu(menus.Characteristics,...
    getString(message('MATLAB:tsguis:histplot:histplot:Mean')), ...
    'tsguis.histMeanData', 'tsguis.histMeanView'); 
set(mean_menu,'Tag','Mean')
ctrl_menu = h.addCharMenu(menus.Characteristics,...
    getString(message('MATLAB:tsguis:histplot:histplot:Median')), ...
