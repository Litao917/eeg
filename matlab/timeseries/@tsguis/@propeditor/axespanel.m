...
if isempty(thisTab)
    ...
    tableModel = tsMatlabCallbackTableModel(tableData,...
            {getString(message('MATLAB:timeseries:tsguis:propeditor:Title')), ...
             getString(message('MATLAB:timeseries:tsguis:propeditor:Scaling')), ...
             getString(message('MATLAB:timeseries:tsguis:propeditor:min',type)), ...
             getString(message('MATLAB:timeseries:tsguis:propeditor:max',type))}, ...
    ...
    javaMethod('add',h.Handles.TabPane, ...
        getString(message('MATLAB:timeseries:tsguis:propeditor:DefineAxesScaling',type)),...
        container);

    % Add the help button
    thisTab.Handles.HelpButton = javaObjectEDT('com.mathworks.mwswing.MJButton',...
        getString(message('MATLAB:timeseries:tsguis:propeditor:Help')));
...
function localSetYScale(~,~,view,LogCheckBox)
