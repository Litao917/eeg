...
% sheet combobox controls whose values are based on the raw data
...
% 'Callback','tsDispatchHelp(''its_wiz_time_column_row_mat'',''modal'')')
...
h.Handles.COMBtimeIndex = uicontrol('Parent',h.Handles.PNLtimeCurrentSheet,...
    ...
    'String',' ',...
    'TooltipString', ...
    getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:SelectARowColumnWhichContainsTheTimeVector')), ...
...
% getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:WhatsThis')), ...
% 'Callback','tsDispatchHelp(''time_units_format_select'',''modal'')')
...
h.Handles.COMBtimeSheetFormat = uicontrol('Parent',h.Handles.PNLtimeCurrentSheet,...
    ...
    'String',' ',...
    'TooltipString', ...
    getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:SelectAProperTimeUnitOrDateFormat')),...
...
h.Handles.TXTtimeSheetStart = uicontrol('Parent',h.Handles.PNLtimeCurrentSheet,...
    ...
    'Units','Pixels',...
    'BackgroundColor',h.DefaultPos.TimePanelDefaultColor,...
    'String',getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:TimeFirstValue')),...
    'HorizontalAlignment','Left', ...
...
uimenu(huicTXTtimeSheetStart,'Label', ...
    getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:WhatsThis')),'Callback','tsDispatchHelp(''time_first'',''modal'')')
...
h.Handles.EDTtimeSheetStart = uicontrol('Parent',h.Handles.PNLtimeCurrentSheet,...
    ...
    'String',' ',...
    'TooltipString', ...
    getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:PutInTheStartingPoint')),...
    'HorizontalAlignment','Left',...
...
uimenu(huicTXTtimeSheetEnd,'Label', ...
    getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:WhatsThis')), ...
    'Callback','tsDispatchHelp(''time_last'',''modal'')')

h.Handles.TXTtimeSheetEnd = uicontrol('Parent',h.Handles.PNLtimeCurrentSheet,...
    'style','text', ...
    'Units','Pixels',...
    'BackgroundColor',h.DefaultPos.TimePanelDefaultColor,...
    'String',getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:LastValue')),...
    'HorizontalAlignment','Left', ...
...
h.Handles.EDTtimeSheetEnd = uicontrol('Parent',h.Handles.PNLtimeCurrentSheet,...
    ...
    'String',' ',...
    'TooltipString', ...
    getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:PutInTheEndingPoint')),...
    'HorizontalAlignment','Left',...
...
if isempty(timeindex)
    ...
    errordlg(getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:InvalidTimeRange')), ...
...
if get(h.Handles.COMBtimeIndex,'Value')==h.IOData.checkLimitColumn+1
    ...
    numlines=1;
    answer=inputdlg(getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:EnterTheColumnIndex')),...
        getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:TimeSeriesTools')),numlines);
    if isempty(answer)
...
if isfield(h.IOData.formatcell,'columnIsAbsTime') && h.IOData.formatcell.columnIsAbsTime>=0
    ...
    set(h.Handles.TXTtimeSheetFormat, ...
        ...
        'UIContextMenu',huicTXTtimeSheetFormat);
    set(h.Handles.COMBtimeSheetFormat,'String', {getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:Weeks')), ...
...
if get(h.Handles.COMBtimeIndex,'Value')==h.IOData.checkLimitRow+1
    ...
    numlines=1;
    answer=inputdlg(getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:EnterTheRowIndex')),...
        getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:TimeSeriesTools')),numlines);
    if isempty(answer)
        % user select 'cancel', jump back to first
        set(h.Handles.COMBtimeIndex,'Value',1);
...
if isfield(h.IOData.formatcell,'rowIsAbsTime') && h.IOData.formatcell.rowIsAbsTime>=0
    ...
    uimenu(huicTXTtimeSheetFormat,'Label', ...
        getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:WhatsThis')), ...
        'Callback','tsDispatchHelp(''time_display_format'',''modal'')')
    set(h.Handles.TXTtimeSheetFormat,'String', ...
        getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:Format')),...
        'UIContextMenu',huicTXTtimeSheetFormat);
    set(h.Handles.COMBtimeSheetFormat,'String',h.IOData.formatcell.matlabFormatString);    
    ...
    uimenu(huicTXTtimeSheetFormat,'Label', ...
        ...
        'Callback','tsDispatchHelp(''time_units_select'',''modal'')')
    set(h.Handles.TXTtimeSheetFormat,'String', ...
        getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:Units')), ...
        'UIContextMenu',huicTXTtimeSheetFormat);
    set(h.Handles.COMBtimeSheetFormat,'String',{getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:Weeks')), ...
        getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:Days')), ...
        getString(message('MATLAB:timeseries:tsguis:workspaceImportdlg:Hours')), ...
