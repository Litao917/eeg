...
LineString = {getString(message('MATLAB:timeseries:tsguis:tsviewer:Solid')); ...
    getString(message('MATLAB:timeseries:tsguis:tsviewer:Dashed')); ...
    getString(message('MATLAB:timeseries:tsguis:tsviewer:DashDot')); ...
    getString(message('MATLAB:timeseries:tsguis:tsviewer:Dotted')); ...
    getString(message('MATLAB:timeseries:tsguis:tsviewer:None'))};
LineData = {'-';'--';'-.';':';'none'};
...
Ltemp = {'-';'--';'-.';':';'none'};
LStemp = {getString(message('MATLAB:timeseries:tsguis:tsviewer:Solid')); ...
    getString(message('MATLAB:timeseries:tsguis:tsviewer:Dashed')); ...
    getString(message('MATLAB:timeseries:tsguis:tsviewer:DashDot')); ...
    getString(message('MATLAB:timeseries:tsguis:tsviewer:Dotted')); ...
    getString(message('MATLAB:timeseries:tsguis:tsviewer:None'))};
...
a = figure(...
   'Name',getString(message('MATLAB:timeseries:tsguis:tsviewer:LineStyles')),...
   'MenuBar','none',...
   'NumberTitle','off',...
   'IntegerHandle','off',...
...
% Add window Options
ButtonStrings=[{getString(message('MATLAB:timeseries:tsguis:tsviewer:OK'))}; ...
    {getString(message('MATLAB:timeseries:tsguis:tsviewer:Cancel'))}; ...
    {getString(message('MATLAB:timeseries:tsguis:tsviewer:Help'))}; ...
    {getString(message('MATLAB:timeseries:tsguis:tsviewer:Apply'))}];
...
%%%-Add text-%%%
OrderText=[{getString(message('MATLAB:timeseries:tsguis:tsviewer:ColorOrder'))};...
    {getString(message('MATLAB:timeseries:tsguis:tsviewer:MarkerOrder'))};...
    {getString(message('MATLAB:timeseries:tsguis:tsviewer:LineStyleOrder'))}];
...
uicontrol('Parent',a, ...
   ...
   'String',getString(message('MATLAB:timeseries:tsguis:tsviewer:DistinguishBy')), ...
   'Tag','DistinquishText', ...
   'BackgroundColor',UIColor, ...
   'Style','text');
uicontrol('Parent',a, ...
   ...
   'String',getString(message('MATLAB:timeseries:tsguis:tsviewer:Color')), ...
   'Tag','ColorText', ...
   'BackgroundColor',UIColor, ...
   'Style','text');
uicontrol('Parent',a, ...
   ...
   'String',getString(message('MATLAB:timeseries:tsguis:tsviewer:Marker')), ...
   'Tag','MarkerText', ...
   'BackgroundColor',UIColor, ...
   'Style','text');
uicontrol('Parent',a, ...
   ...
   'String',getString(message('MATLAB:timeseries:tsguis:tsviewer:LineStyle')), ...
   'Tag','LineText', ...
   'BackgroundColor',UIColor, ...
   'Style','text');
b = uicontrol('Parent',a, ...
   ...
   'String',getString(message('MATLAB:timeseries:tsguis:tsviewer:NoDistinction')), ...
   'Tag','NoText', ...
   'BackgroundColor',UIColor, ...
   'Style','text'); %#ok<*NASGU>

DifferentText=[{getString(message('MATLAB:timeseries:tsguis:tsviewer:TimeSeries'))}; ...
    {getString(message('MATLAB:timeseries:tsguis:tsviewer:Columns'))}];
