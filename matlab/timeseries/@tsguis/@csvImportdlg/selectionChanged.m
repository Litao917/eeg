function selectionChanged(h,selectedRows,selectedCols,scrollToSelectionFlag)
...
updateTableDisp(h,scrollToSelectionFlag)
if ignored==h.IOData.checkLimit
    msgbox(sprintf(getString(message('MATLAB:tsguis:csvImportdlg:selectionChanged:TimeValuesAreInvalid',...
        h.IOData.checkLimit))),getString(message('MATLAB:tsguis:csvImportdlg:selectionChanged:TimeSeriesTools')));
end
