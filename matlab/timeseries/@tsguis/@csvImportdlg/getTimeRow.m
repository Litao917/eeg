...
if ~isempty(h.Handles.tsTable)
    ...
    try
        ...
        errordlg(getString(message('MATLAB:tsguis:csvImportdlg:getTimeRow:InvalidTimesSelected')),...
            getString(message('MATLAB:tsguis:csvImportdlg:getTimeRow:TimeSeriesTools')),'modal');
        time=[];
        timeFormat=[];
        return
    end
