...
% return value is empty. time format stores the Standard MATLAB format
...
try
    ...
    errordlg(getString(message('MATLAB:tsguis:csvImportdlg:getTimeColumn:InvalidTimesSelected')),...
        getString(message('MATLAB:tsguis:csvImportdlg:getTimeColumn:TimeSeriesTools')),'modal');
    time=[];
    timeFormat=[];
    return
end
