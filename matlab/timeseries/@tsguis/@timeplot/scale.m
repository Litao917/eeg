...
%% the structure contained in the SelectionStruct property
...
elseif strcmp(mode,'complete')
    ...
    if strcmp(recorder.Recording,'on')
        T.addbuffer(['%% ' getString(message('MATLAB:timeseries:tsguis:timeplot:TimeSeriesRescaling'))]);
        T.addbuffer(sprintf('%s.Data = %s.Data*(%f)+%f;',genvarname(thists.Name),...
            genvarname(thists.Name),SF,offset),thists);
    end
