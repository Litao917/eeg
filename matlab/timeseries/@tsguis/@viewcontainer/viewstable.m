...
%% Rebuild the views table. Additional argument is a view to be excluded
...
headings = {...
    getString(message('MATLAB:timeseries:tsguis:viewcontainer:NodeLabel')), ...
    getString(message('MATLAB:timeseries:tsguis:viewcontainer:Title')), ...
    getString(message('MATLAB:timeseries:tsguis:viewcontainer:DomainLimits'))};   
