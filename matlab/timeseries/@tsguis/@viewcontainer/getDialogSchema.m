...
h.Handles.PNLViews = uipanel('Parent',f,'Units','Characters','Title',...
    getString(message('MATLAB:timeseries:tsguis:viewcontainer:CurrentPlots')), ...
    'Position',[0.02 0.52 0.96 0.46]);
h.viewstable
set(h.Handles.PNLviewsTable,'Units','Pixels','Parent',h.Handles.PNLViews);
BTNadd = uicontrol('Style','Pushbutton', ...
    'String',getString(message('MATLAB:timeseries:tsguis:viewcontainer:AddPlot')), ...
    'Parent',h.Handles.PNLViews,...
    'Units','Characters','Callback',{@localAddPlot h manager});
BTNremove = uicontrol('Style','Pushbutton', ...
    'String',getString(message('MATLAB:timeseries:tsguis:viewcontainer:RemovePlot')), ...
    'Parent',h.Handles.PNLViews,...
    'Units','Characters','Callback',{@localRemoveView h});
BTNedit = uicontrol('Style','Pushbutton', ...
    'String',getString(message('MATLAB:timeseries:tsguis:viewcontainer:EditPlot')), ...
    'Parent',h.Handles.PNLViews,...
...
h.Handles.PNLTs = uipanel('Parent',f,'Units','Characters','Title', ...
    getString(message('MATLAB:timeseries:tsguis:viewcontainer:TimeSeriesInSelectedView')), ...
