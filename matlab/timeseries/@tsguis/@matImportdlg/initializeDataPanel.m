...
strSpecifyData = getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:SpecifyData'));
...
strDataIsArrangedBy = getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:DataIsArrangedBy'));
h.Handles.TXTdataSample = uicontrol('Parent',h.Handles.PNLdata, ...
    'style','text', ...
    'Units','Pixels', ...
    'BackgroundColor',h.DefaultPos.DataPanelDefaultColor, ...
    'String',sprintf('%s : ',strDataIsArrangedBy), ...
    ...
    'Tag', 'TXTdataSample');
uimenu(huicTXTdataSample,'Label',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:WhatsThis')),'Callback','tsDispatchHelp(''its_wiz_data_arranged_by'',''modal'')')


strDataOrganizedByColumn = getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:DataOrganizedByColumn'));
h.Handles.COMBdataSample = uicontrol('Parent',h.Handles.PNLdata, ...
    'style','popupmenu', ...
    'Units','Pixels', ...
    'String',[{getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:Columns'))},{getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:Rows'))}], ...
    'Value',1,...
    'TooltipString',strDataOrganizedByColumn, ...
...
h.Handles.BTNrefresh = uicontrol('Parent',h.Handles.PNLdata, ...
    'style','pushbutton', ...
    'Units','Pixels', ...
    'String',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:RefreshList')),...
...
uimenu(huicBTNrefresh,'Label',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:WhatsThis')),'Callback','tsDispatchHelp(''its_wiz_refresh'',''modal'')')

huicTXTFROM = uicontextmenu('Parent',h.Figure);
strSelectedRows = getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:SelectedRows'));
h.Handles.TXTFROM = uicontrol('Parent',h.Handles.PNLdata, ...
    'style','text', ...
    'Units','Pixels', ...
    'BackgroundColor',h.DefaultPos.DataPanelDefaultColor, ...
    'String',sprintf('%s : ',strSelectedRows), ...
    'HorizontalAlignment','Left', ...
...
uimenu(huicTXTFROM,'Label',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:WhatsThis')),'Callback','tsDispatchHelp(''its_wiz_selected_row'',''modal'')')
...
h.Handles.EDTFROM = uicontrol('Parent',h.Handles.PNLdata, ...
    ...
    'String','', ...
    'TooltipString',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:KeyInRowIndices')), ...
    'HorizontalAlignment','Left', ...
...
strSelectedColumns = getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:SelectedColumns'));
h.Handles.TXTTO = uicontrol('Parent',h.Handles.PNLdata, ...
    'style','text', ...
    'Units','Pixels', ...
    'BackgroundColor',h.DefaultPos.DataPanelDefaultColor, ...
    'String',sprintf('%s : ',strSelectedColumns), ...
    'HorizontalAlignment','Left', ...
...
uimenu(huicTXTTO,'Label',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:WhatsThis')),'Callback','tsDispatchHelp(''its_wiz_selected_col'',''modal'')')
...
h.Handles.EDTTO = uicontrol('Parent',h.Handles.PNLdata, ...
    ...
    'BackgroundColor',[1 1 1],...
    'String','',...
    'TooltipString',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:KeyInColumnIndices')), ...
    'HorizontalAlignment','Left',...
...
try
    ...
    msgbox(getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:UseStandardMATLABIndexing')),getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:TimeSeriesTools')));
    return;
end
...
if strcmpi(str,'row')
    ...
    strSpecifyRowNumber = getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:SpecifyRowNumber'));
    uimenu(huicTXTmultipleNEW,'Label',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:WhatsThis')),'Callback','tsDispatchHelp(''its_wiz_name_ts_from_row'',''modal'')')
    set(h.Parent.Handles.TXTmultipleNEW,'String',sprintf('%s : ',strSpecifyRowNumber),'UIContextMenu',huicTXTmultipleNEW);
    set(h.Parent.Handles.EDTmultipleNEW,'String','1');
    h.TimePanelUpdate('column');
else
    % a sample is a column
    huicTXTmultipleNEW = uicontextmenu('Parent',h.Figure);
    strSpecifyColumnNumber = getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:SpecifyColumnNumber'));
    uimenu(huicTXTmultipleNEW,'Label',getString(message('MATLAB:tsguis:matImportdlg:initializeDataPanel:WhatsThis')),'Callback','tsDispatchHelp(''its_wiz_name_ts_from_column_mat'',''modal'')')
    set(h.Parent.Handles.TXTmultipleNEW,'String',sprintf('%s : ',strSpecifyColumnNumber),'UIContextMenu',huicTXTmultipleNEW);
    set(h.Parent.Handles.EDTmultipleNEW,'String','1');
