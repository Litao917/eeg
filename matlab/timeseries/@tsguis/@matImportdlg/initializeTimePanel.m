...
strSpecifyTimeVector = getString(message('MATLAB:tsguis:matImportdlg:initializeTimePanel:SpecifyTimeVector'));
...
strTimevectorSource = getString(message('MATLAB:tsguis:matImportdlg:initializeTimePanel:TimevectorSource'));
...
uimenu(huicTXTtimeSheet,'Label',getString(message('MATLAB:tsguis:matImportdlg:initializeTimePanel:WhatsThis')),'Callback','tsDispatchHelp(''its_wiz_time_src_for_mat'',''modal'')')

h.Handles.COMBtimeSource = uicontrol('Parent',h.Handles.PNLtime,...
    'style','popupmenu',...
    'Units', 'Pixels',...
    'String',[{getString(message('MATLAB:tsguis:matImportdlg:initializeTimePanel:CurrentVariable'))},{getString(message('MATLAB:tsguis:matImportdlg:initializeTimePanel:DefineItNow'))},{getString(message('MATLAB:tsguis:matImportdlg:initializeTimePanel:AnotherVariable'))}], ...
    'Value',2,...
    'TooltipString',getString(message('MATLAB:tsguis:matImportdlg:initializeTimePanel:TimeVectorObtainedUseDropdown')),...
