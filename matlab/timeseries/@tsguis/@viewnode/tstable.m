...
headings = {getString(message('MATLAB:timeseries:tsguis:viewnode:TimeSeries')), ...
    getString(message('MATLAB:timeseries:tsguis:viewnode:Path')), ...
    getString(message('MATLAB:timeseries:tsguis:viewnode:Size')),...
    getString(message('MATLAB:timeseries:tsguis:viewnode:SubplotIndex')), ...
    getString(message('MATLAB:timeseries:tsguis:viewnode:Visible'))};
