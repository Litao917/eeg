...
str = {getString(message('MATLAB:timeseries:tsguis:tsMeanView:Mean',r.Name))};
[iotxt,ShowFlag] = rcinfo(r,info.Row,info.Col); 
if any(AxGrid.Size(1:2)>1) | ShowFlag 
    % Show if MIMO or non trivial 
    str{end+1,1} = getString(message('MATLAB:timeseries:tsguis:tsMeanView:Column',info.Row)); 
end
