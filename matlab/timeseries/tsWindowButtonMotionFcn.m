function tsWindowButtonMotionFcn(eventSrc, ~, h)
%
...
if (strcmp(h.State,'TimeseriesScaling') || strcmp(h.State,'TimeseriesTranslating')) ...
        && (~isfield(h.SelectionStruct,'Arrowpressed') || isempty(h.SelectionStruct.Arrowpressed) || ...
        ~h.SelectionStruct.Arrowpressed) && ~isempty(h.SelectionStruct.StartPoint)               
    %% Get the current point
    pt = get(h.AxesGrid.getaxes,'CurrentPoint');  
    point = pt(1,1:2);
