function [fieldsize, ntype, dimlist] = fieldInfo(swathID,fieldName)
...
[~,fieldsize,ntype,rdimlist,status] = hdfsw('fieldinfo',swathID,fieldName);
hdfeos_sw_error(status,'SWfieldinfo');

% Reverse the order of fieldsize because of majority issue.
fieldsize = fliplr(fieldsize);
