...
%   HDFTOOL will be removed in a future release.  To read data from an HDF
%   file, use HDFREAD, MATLAB.IO.HDF4.SD, MATLAB.IO.HDFEOS.GD, or 
...
%   Copyright 2001-2013 The MathWorks, Inc.
    ...
    warning(message('MATLAB:imagesci:hdftool:FunctionToBeRemoved'));
