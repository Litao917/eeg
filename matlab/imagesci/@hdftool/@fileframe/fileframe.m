...
%   Copyright 2005-2013 The MathWorks, Inc.
    ...
    set(this.figureHandle, 'Pointer', 'arrow');
    feval(@ResizeFcn, this.figureHandle, [], this.prefs.minFigureSize);
...
function createMenus(this)
    ...
    % File Menu
    theLabel = getString(message('MATLAB:imagesci:hdftool:file'));
    fileMenu = uimenu('Parent',this.figureHandle,...
        ...
        'Tag','fileMenu');
    theLabel = getString(message('MATLAB:imagesci:hdftool:openFile'));
    uimenu('Parent',fileMenu,...
        ...
        'Accelerator','O',...
        'Tag','openMenu');
    theLabel = getString(message('MATLAB:imagesci:hdftool:importMenuLabel'));
    this.importMenu = uimenu('Parent',fileMenu,...
        ...
        'Accelerator','I',...
        'Tag','importMenu');
    theLabel = getString(message('MATLAB:imagesci:hdftool:closeFile'));
    closeMenu = uimenu('Parent',fileMenu,...
        ...
        'Accelerator','W',...
        'Tag','closeFileMenu');
    theLabel = getString(message('MATLAB:imagesci:hdftool:closeAllFiles'));
    closeAllMenu = uimenu('Parent',fileMenu,...
        'Label',theLabel,...
        'Callback', @(varargin)(this.closeAllFiles()),...
        'ForegroundColor', this.prefs.colorPrefs.menuTextColor,...
        'Tag','closeAllFilesMenu');
    theLabel = getString(message('MATLAB:imagesci:hdftool:closeHdfTool'));
    uimenu('Parent',fileMenu,'Label',theLabel,...
        'Callback', @(varargin)(this.close()),...
        'ForegroundColor', this.prefs.colorPrefs.menuTextColor,...
        'Tag','closeToolMenu');

    % Help Menu
    helpLabel = getString(message('MATLAB:imagesci:hdftool:help'));
    helpMenu = uimenu('Parent',this.figureHandle,...
        'Label',['&' helpLabel], ...
        'ForegroundColor', this.prefs.colorPrefs.menuTextColor,...
        'Tag','helpMenu');
    uimenu('Parent',helpMenu,...
           'Label',['HDFTool' helpLabel], ... 
           'callback',@(varargin)(showHelp(this, 'hdftool_help')),...
           'ForegroundColor', this.prefs.colorPrefs.menuTextColor,...
           'Accelerator','H',...
           'Tag','helpOverviewMenu');
    theLabel = getString(message('MATLAB:imagesci:hdftool:subsettingOptions'));
    uimenu('Parent',helpMenu,...
           'Label',theLabel, ...
