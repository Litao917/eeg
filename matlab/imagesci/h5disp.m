...
%--------------------------------------------------------------------------
function display_group(group,context,level)
%
...
display_links(group.Links,context,level+1);
display_named_datatypes(group.Datatypes,context,level+1);
display_datasets(group.Datasets,context,level+1);

display_child_groups(group.Groups,context,level+1);



%--------------------------------------------------------------------------
function display_child_groups(groups,context,level)

for j = 1:numel(groups)
    display_group(groups(j),context,level);
end

%--------------------------------------------------------------------------
function display_links(links,context,level)

for j = 1:numel(links)
    display_link(links(j),context,level);
end
...
%--------------------------------------------------------------------------
function display_link(link,context,level)
%
% This function displays something like:
%
% Link 'dset3'
