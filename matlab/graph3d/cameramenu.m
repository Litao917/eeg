...
if matlab.graphics.internal.isGraphicsVersion1
    uimenu(Udata.sceneMenuHandle, ...
        'Label', getString(message('MATLAB:cameramenu:Label_LightingPhong')), ...
        'callback', 'lighting(gca(gcbf),''phong'')','tag','Cameramenu_Scene_LightingPhong');
end
uimenu(Udata.sceneMenuHandle, ...
...
if matlab.graphics.internal.isGraphicsVersion1
    uimenu(Udata.rendererMenuHandle, ...
        'Label', getString(message('MATLAB:cameramenu:Label_Zbuffer')), ...
        'callback', 'cameramenu(''changerenderer'')','tag','Cameramenu_Renderer_ZBuffer');
end
uimenu(Udata.rendererMenuHandle, ...
