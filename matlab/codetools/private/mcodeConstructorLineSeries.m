...
if isVectorOutput
    ...
    set(hFunc,'Comment',...
        sprintf(getString(message('MATLAB:codetools:private:mcodeConstructorLineSeries:CreateMultipleLinesUsingMatrix',constructor_name))));
