...
classdef StructArrayVariableEditorAdapter
    ...
    methods (Static=true)
        ...
        function varargout = variableEditorGridSizeWorkspace(workspaceID, workspaceVariableName)
            ...
            currentValue = evalin(theWorkspace, workspaceVariableName);
            ...
            if (col <= numFields)
                ...
                if ~isempty(lhs) && isequal(lhs, rhsValue)
                    ...
                    if isempty(rhs)
                        ...
                        code = [workspaceVariableName '(' num2str(row) ').' allFieldNames{col} ' = ' rhs ';'];
                    end
                end
        ...
        function [code,msg] = variableEditorSortCode(this, varName, ...
            ...
            if ischar(structFields)
                ...
                for i=1:length(structFields)
                    ...
                    allStr = allStr & cellfun(@isstr, varData);
            ...
            if all(allNumbers | allLogical) && ~any(emptyVals)
                if direction
