function abstractMembers = abstractDetails(classReference)
    ...
    %    meta.abstractDetails(classname) displays a list of abstract methods
    %    and properties for the class with name 'classname'.  Use the fully
    %    specified name for classes in packages.  All public and protected
    %    abstract methods and properties are displayed, including those
    %    declared hidden.
    %
    %    meta.abstractDetails(mc) displays the abstract methods and properties
    %    for the class represented by the meta.class object mc.
    %
    %    absMembers = meta.abstractDetails(mc) returns an array of metaclass 
    %    objects corresponding to the abstract members of the class represented 
    %    by meta.class object mc. If the class has both abstract methods  
    %    and abstract properties, absMembers will be a heterogeneous array  
    %    containing meta.method and meta.property objects.
    %
    %    Examples:
