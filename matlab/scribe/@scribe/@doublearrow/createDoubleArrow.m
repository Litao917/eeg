...
% un-rotated x,y,z vectors for line part
...
% Head 1
% un-rotated x,y,z vectors for arrow
...
hThis.Head1LineWidth = defaultLineWidth;
hThis.Head2LineWidth = defaultLineWidth;
...
if ~hThis.UpdateInProgress
    ...
    hFig = ancestor(hThis,'Figure');
    R1 = hgconvertunits(hFig,[0 0 hThis.NormX(1) hThis.NormY(1)],'normalized','points',hFig);
    R2 = hgconvertunits(hFig,[0 0 hThis.NormX(2) hThis.NormY(2)],'normalized','points',hFig);
    PX = [R1(3) R2(3)];
    PY = [R1(4) R2(4)];
    ...
    % un-rotated x,y,z vectors for arrow head 1
    L = hThis.Head1Length;
    ...
    % un-rotated x,y,z vectors for arrow head 2
    L = hThis.Head2Length;
