...
hThis.EdgeColorDescription = getString(message('MATLAB:uistring:plotedittoolbar:Color'));
...
hThis.TextColorDescription = getString(message('MATLAB:uistring:plotedittoolbar:TextColor'));
...
hThis.TextLineWidth = defaultLineWidth;
