...
if isempty(uic)
  ...
  % Refresh
  hMenu = graph2dhelper('createScribeUIMenuEntry',fig,'GeneralAction',getString(message('MATLAB:uistring:scribemenu:Refresh')),'','',{@refresh_cb,h});
  set(hMenu,'Tag','scribe:legend:refresh');
  % Delete
  hMenu(end+1) = graph2dhelper('createScribeUIMenuEntry',fig,'GeneralAction',getString(message('MATLAB:uistring:scribemenu:Delete')),'','',{@delete_cb,h});
  set(hMenu(end),'Tag','scribe:legend:delete');
  % Color
  hMenu(end+1) = graph2dhelper('createScribeUIMenuEntry',fig,'Color',getString(message('MATLAB:uistring:scribemenu:ColorDotDotDot')),'Color',getString(message('MATLAB:uistring:scribemenu:Color')));
  set(hMenu(end),'Separator','on');
  set(hMenu(end),'Tag','scribe:legend:color');
  % Edge color (xcolor and ycolor)
  hMenu(end+1) = graph2dhelper('createScribeUIMenuEntry',fig,'Color',getString(message('MATLAB:uistring:scribemenu:EdgeColorDotDotDot')),{'XColor','YColor'},getString(message('MATLAB:uistring:scribemenu:EdgeColor')));
  set(hMenu(end),'Tag','scribe:legend:edgecolor');
  % Line width
  hMenu(end+1) = graph2dhelper('createScribeUIMenuEntry',fig,'LineWidth',getString(message('MATLAB:uistring:scribemenu:LineWidth')),'LineWidth',getString(message('MATLAB:uistring:scribemenu:LineWidth')));
  ...
  % Font properties
  hMenu(end+1) = graph2dhelper('createScribeUIMenuEntry',fig,'Font',getString(message('MATLAB:uistring:scribemenu:FontDotDotDot')),'',getString(message('MATLAB:uistring:scribemenu:Font')));
  set(hMenu(end),'Tag','scribe:legend:font');
  % Interpreter
  hMenu(end+1) = graph2dhelper('createScribeUIMenuEntry',fig,'TextInterpreter',getString(message('MATLAB:uistring:scribemenu:Interpreter')),'Interpreter',getString(message('MATLAB:uistring:scribemenu:Interpreter')));
  ...
  % Location
  hMenu(end+1) = graph2dhelper('createScribeUIMenuEntry',fig,'EnumEntry',getString(message('MATLAB:uistring:scribemenu:Location')),'Location',getString(message('MATLAB:uistring:scribemenu:Location')),...
      cellfun(@(x)getString(message(['MATLAB:uistring:scribemenu:' x ])),{'Best','InsideNorthEast','OutsideNorthEast','InsideSouthEast','InsideNorthWest','OutsideNorthWest','InsideSouthWest'},'UniformOutput',false),...
  ...
  % Orientation
  hMenu(end+1) = graph2dhelper('createScribeUIMenuEntry',fig,'EnumEntry',getString(message('MATLAB:uistring:scribemenu:Orientation')),'Orientation',getString(message('MATLAB:uistring:scribemenu:Orientation')),...
  ...
  % Property Editor.  Do not add the menu for deployed applications.
  if( ~isdeployed && ~ismcc)
      hMenu = uimenu(uic,'HandleVisibility','off','Separator','on',...
                     'Label',getString(message('MATLAB:uistring:scribemenu:ShowPropertyEditor')),'Callback',{@localOpenPropertyEditor,h});
      set(hMenu,'Tag','scribe:legend:propedit');
  end
  % Code. Do not add the menu for deployed applications.
  if ( ~isdeployed && ~ismcc)
      hMenu = uimenu(uic,'HandleVisibility','off','Separator','on',...
