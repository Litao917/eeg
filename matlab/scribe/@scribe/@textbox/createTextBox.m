...
hThis.EdgeColorDescription = getString(message('MATLAB:uistring:plotedittoolbar:EdgeColor'));

% Set the Face Color Property to correspond to the "HeadColor" property of the
% line.
hThis.FaceColorProperty = 'BackgroundColor';
hThis.FaceColorDescription = getString(message('MATLAB:uistring:plotedittoolbar:BackgroundColor'));
...
hThis.LineWidth = get(0,'DefaultLineLineWidth');
hThis.LineStyle = get(0,'DefaultLineLineStyle');
