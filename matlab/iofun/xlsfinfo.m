...
%
%   NOTE: On Windows systems with Excel software, XLSFINFO obtains
%   information using the COM server, which is part of the typical Excel
%   installation.  If the COM server is unavailable, XLSFINFO warns that it
%   cannot start an ActiveX server. In this case, consider reinstalling
%   your Excel software.
%
