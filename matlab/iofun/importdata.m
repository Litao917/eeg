...
%   with nonnumeric characters anywhere else, including columns of 
%   character data or formatted dates or times, use TEXTSCAN instead of 
%   IMPORTDATA.  When importing spreadsheets with columns of nonnumeric 
%   data, IMPORTDATA cannot always correctly interpret the column and row 
%   headers.
%
%   Examples:
%
        ...
        if any(strcmp(['.' FileType], matlab.io.internal.xlsreadSupportedExtensions))
            ...
            case 'avi'
                ...
                if strcmp(vidObj.VideoFormat, 'RGB24')
                    ...
                    % to be put into a MOV struct to be compatible with
                    % aviread.
